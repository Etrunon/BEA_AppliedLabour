...
outreg using "$results/06_tmp3Outreg2", ///
    tex se bdec(2) starlevels(10 5 1) starloc(1) replace ///
    ctitle("Variables" "Model 'Age Wage Gender'") squarebrack 
...
reg v01_isPartTimeInvoluntary  ///
    ...
    i.v20_isGenderFemale
outreg using "$results/06_tmp2Outreg2", ///
    tex se bdec(2) starlevels(10 5 1) starloc(1) replace merge ///
    ctitle("Variables" "Model 'Significant Vars'") squarebrack 
...
outreg using "$results/06_tmpOutreg2", ///
    se bdec(2) starlevels(10 5 1) starloc(1) replace merge ///
    ctitle("Variables" "Model 'All variables'") squarebrack 
...
esttab using "$results/06_LatexOutreg", label booktabs replace
